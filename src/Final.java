...
public class Final extends JFrame {
    ...
    public Final() {
        ...
        resultArea.setEditable(false); // 편집 불가능하게 설정
        JScrollPane scrollPane = new JScrollPane(resultArea); // 스크롤바 추가

        panel.add(scrollPane, BorderLayout.CENTER); // 패널에 스크롤 가능한 영역 추가
        add(panel);

        printGugudan();

        setVisible(true); // [문제6] 결과 화면의 윈도우를 출력해 주세요.
    }
    ...
    private void printGugudan() {
        ...
        resultArea.setText(sb.toString()); // 결과 영역에 구구단 내용 설정
